...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $this->call(Table_13_Seeder::class);
        $this->call(Table_14_Seeder::class);
        $this->call(Table_12_Seeder::class);

        $this->call(Table_15_Seeder::class);
        $this->call(Table_16_Seeder::class);
